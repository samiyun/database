...
MetaCommandResult do_meta_command(InputBuffer* input_buffer, Table* table) {
  if (strcmp(input_buffer->buffer, ".exit") == 0) {
    ...
    return META_COMMAND_SUCCESS;
      ...
      printf("  .exit       - Save state and exit the database\n");
      printf("  .btree      - Print the internal B-Tree node structure\n");
      printf("  .constants  - Print the byte sizes of internal data structures\n");
      printf("  .help       - Show this help message\n");
      printf("  insert      - Insert a new row (format: insert <id> <username> <email>)\n");
      printf("  select      - Print all rows currently in the database\n");
    return META_COMMAND_SUCCESS;
...
/*
    this file acts as a 'fixed' version of the tutorials codebase as it was outdated. this just removes the use of 'const' and replaces it with the define keyword
*/